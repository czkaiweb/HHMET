...
// using the distance to line (0,0)->(120,115) to select the higgs pair
	...
	j2=subleading_index[pair_index][2];
	j3=subleading_index[pair_index][3];
    ...
    TLorentzVector h_leading_4v,h_subl_4v;
    ...
    h_subleading_pt->Fill(h_leading_4v.Pt());
    h_m_lead->Fill(h_leading_4v.M());
    h_m_subl->Fill(h_leading_4v.M());
////////////////////////////////////////////////////////////////////////
...
h_m_4j->Write();
  ...
  ofstream fileout("cutflow_check.dat");
